...
function greenhouse_job_board_gh_settings_section_callback(  ) { 
	...
	echo __( '<p>Configure to your Greenhouse account. These settings will be the defaults across this website. You may use the shortcode attributes to override these defaults if you wish.</p>', 'greenhouse_job_board' );
