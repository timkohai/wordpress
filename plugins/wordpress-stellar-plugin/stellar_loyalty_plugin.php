 ...
 */
/*
Plugin Name: Stellar Elements Shortcodes 17
...
require_once( STELLAR__PLUGIN_DIR . 'admin/stellar-admin-settings.php' );
require_once( STELLAR__PLUGIN_DIR . 'stellar-elements/stellar-elements-shortcodes.php' );
    ...
    <div class="stellar-wrapper">
	    ...
	    <div class="login-wrapper row">
	        <form id="forgot-password-form" method="post" novalidate>
	            ...
	            <div class="form-group forgot-password-fields">
	            ...
	            <div class="form-group success-buttons">
	              <button class="btn btn-primary open-in-mobile-app" style="display: none">Open in Mobile App</button>
	              <button class="btn btn-primary return-to-signin" style="display: none">Return to Login</button>
	            </div>
	        </form>
	    </div>
	</div>
			    ...
			    <form id="reset-password-form" method="post" novalidate>
			        ...
			        <div class="success-message" style="display: none;">
			            <p>
                            ...
                            <span> You have successfully reset your password. </span> <br>
                            <div class="form-group success-buttons">
					          <a href="#" class="btn btn-primary open-in-mobile-app" style="display: none">Open in Mobile App</a>
					          <a href="#" class="btn btn-primary return-to-signin">Return to Login</a>
					        </div>
			            </p>
			        </div>
...
function rewards_member_summary($attr, $content) {
	...
	return '<div class="member-rewards-summary">
        ...
        <div class="progress-rewards-content">
            ...
            <div class="rewards-activated-count">You’ve activated <span class="activated-rewards-count">0</span> <span class="rewards-label">rewards</span></div>
