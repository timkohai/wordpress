...
<html xmlns="https://www.w3.org/1999/xhtml" lang="en-US" xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml">
   <head>
      ...
      <style type="text/css">
         ...
         color:#9a1e5b !important;
         }
         .fusion-content-boxes .heading-link:hover .icon i, .fusion-accordian .panel-title a:hover .fa-fusion-box {
         background-color: #9a1e5b !important;
         border-color: #9a1e5b !important;
         }
         ...
         border-right-color:#9a1e5b;
         border-left-color:#9a1e5b;
         }
         .header-v2 .header-social, .header-v3 .header-social, .header-v4 .header-social,.header-v5 .header-social,.header-v2{
         border-top-color:#9a1e5b;
         }
         ...
         body #header-sticky.sticky-header .sticky-shadow{background:rgba(0, 0, 0, 0.8);}
         .no-rgba #header-sticky.sticky-header .sticky-shadow{background:; filter: progid: DXImageTransform.Microsoft.Alpha(Opacity=80); opacity: 0.8;}
         #header,#small-nav,#side-header{
         background-color:;
         background-color:rgba(0,0,0,0);
         }
         #main,#wrapper,
         .fusion-separator .icon-wrapper, html, body, .bbp-arrow { background-color:#cccccc; }
         .footer-area{
         ...
         .image .image-extras{
         background-image: linear-gradient(top, rgba(154,30,90,0.8) 0%, rgba(154,30,90,0.8) 100%);
         background-image: -o-linear-gradient(top, rgba(154,30,90,0.8) 0%, rgba(154,30,90,0.8) 100%);
         background-image: -moz-linear-gradient(top, rgba(154,30,90,0.8) 0%, rgba(154,30,90,0.8) 100%);
         background-image: -webkit-linear-gradient(top, rgba(154,30,90,0.8) 0%, rgba(154,30,90,0.8) 100%);
         background-image: -ms-linear-gradient(top, rgba(154,30,90,0.8) 0%, rgba(154,30,90,0.8) 100%);
         background-image: -webkit-gradient(
         linear,
         left top,
         left bottom,
         color-stop(0, rgba(154,30,90,0.8)),
         color-stop(1, rgba(154,30,90,0.8))
         );
         filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#9a1e5a', endColorstr='#9a1e5a')
         ...
         background: #9a1e5a;
         color: #fff;
         background-image: -webkit-gradient( linear, left bottom, left top, from( #9a1e5a ), to( #9a1e5a ) );
         background-image: -webkit-linear-gradient( bottom,#9a1e5a, #9a1e5a );
         background-image:  -moz-linear-gradient( bottom, #9a1e5a, #9a1e5a );
         background-image:    -o-linear-gradient( bottom, #9a1e5a, #9a1e5a );
         background-image: linear-gradient( to top,#9a1e5a, #9a1e5a );  
         filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#9a1e5a', endColorstr='#9a1e5a');
         ...
         background: #b13a74;
         color: #ffffff;
         background-image: -webkit-gradient( linear, left bottom, left top, from( #9a1e5a ), to( #b13a74 ) );
         background-image: -webkit-linear-gradient( bottom, #9a1e5a, #b13a74 );
         background-image:  -moz-linear-gradient( bottom, #9a1e5a}, #b13a74 );
         background-image:    -o-linear-gradient( bottom, #9a1e5a, #b13a74 );
         background-image: linear-gradient( to top, #9a1e5a, #b13a74 );
         filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#b13a74', endColorstr='#9a1e5a');
         }
         ...
         .sidebar .widget h3, .sidebar .widget .heading h3{color:#9a1e5a;}
         .footer-area h3{color:#9a1e5a;}
         ...
         #nav ul ul,#sticky-nav ul ul{border-color:#ededed;}
         #wrapper .main-nav-search .search-link:hover:after, #wrapper .main-nav-search.search-box-open .search-link:after, #wrapper .my-cart-link:hover:after {color:#ededed;}
         #nav ul ul,#sticky-nav ul ul,
         ...
         body .sidebar .fusion-tabs-widget .tab-hold .tabs li.active a, body .sidebar .fusion-tabs-widget .tab-holder .tabs li.active a{border-top-color:#9a1e5b;}
         ...
         background: linear-gradient(to top, #cccccc, #ffffff ) #3E3E3E;
         background: -o-linear-gradient(to top, #cccccc, #ffffff ) #3E3E3E;
         background: -moz-linear-gradient(to top, #cccccc, #ffffff ) #3E3E3E;
         background: -webkit-linear-gradient(to top, #cccccc, #ffffff ) #3E3E3E;
         background: -ms-linear-gradient(to top, #cccccc, #ffffff ) #3E3E3E;
         background: linear-gradient(to top, #cccccc, #ffffff ) #3E3E3E;
         background-image: -webkit-gradient(
         linear,
         left top,
         ...
         .header-v4 #small-nav,.header-v5 #small-nav{background-color:#9a1e5b;}
         ...
         background-image:url(http://beta.plummarket.com/dev/wp-content/themes/Avada/images/page_title_bg.png);
         }
         .page-title-container{
         background-color:#F6F6F6;
         }
         ...
         #header, #small-nav, #side-header {
         background-color: rgba(154, 30, 90, 0.75);
         }
         .header-v4 #small-nav {
         padding: 0 10px;
         background-color:#9a1e5b;
            ...
            <div class="header-v4">
               <header id="header">
                  <div class="avada-row" style="padding-top:0px;padding-bottom:0px;">
                     ...
                     <div class="selected-store"><a href="/find-your-store">(find your store)</a></div>
                  </div>
               </header>
               <div id="small-nav">
                  <div class="avada-row">
                     <nav id="nav" class="nav-holder">
                        <ul class="navigation menu fusion-navbar-nav" style="overflow:hidden">
                           ...
                           <li id="menu-item-89" class="myrewards menuItem menu-item menu-item-type-custom menu-item-object-custom menu-item-89"><a href="http://rewards.plummarket.com">myRewards</a></li>
                           <li id="menu-item-91" class="menuItem menu-item menu-item-type-custom menu-item-object-custom menu-item-91"><a href="/find-your-winebar/">Wine Events</a></li>
                           <li id="menu-item-442" class="visible-xs-block your-store-mobile-menu menu-item menu-item-type-custom menu-item-object-custom menu-item-442"><a href="#">Your Store</a></li>
                           <li id="menu-item-440" class="visible-xs-block menu-item menu-item-type-custom menu-item-object-custom menu-item-440"><a href="/store">Shop Online</a></li>
                        </ul>
                     </nav>
